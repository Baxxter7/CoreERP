...
builder.Services.AddTransient<PropageJwtHandler>();
...
{
    c.SwaggerDoc("v1", new() { Title = "ComprasAPI", Version = "v1" });
...
{
    c.BaseAddress = new Uri(builder.Configuration["InventariosApiUrl"]!);
}).AddHttpMessageHandler<PropageJwtHandler>();

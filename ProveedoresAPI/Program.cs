...
using ProveedoresAPI.Controllers;
...
{
    c.SwaggerDoc("v1", new() { Title = "ProveedoresAPI", Version = "v1" });
...
{
    var db = scope.ServiceProvider.GetRequiredService<ProveedoresDbContext>();
    db.Database.Migrate();
}
